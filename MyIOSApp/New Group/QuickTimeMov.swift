...
//  MyIOSApp
//
//  Created by Yunhao on 2019/6/20.
...
//    fileprivate let path : String
    fileprivate let avAsset: AVAsset
...
//            DTLog("error")
    ...
    fileprivate func metadata() -> [AVMetadataItem] {
        return avAsset.metadata(forFormat: .quickTimeMetadata)
    }
    
    fileprivate func track(_ mediaType : AVMediaType) -> AVAssetTrack? {
        return avAsset.tracks(withMediaType: mediaType).first
    }
